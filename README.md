# embedded-alerts-libs (superseded)

> This repository is frozen. The canonical source of truth is [`eal-libs`](https://github.com/embedded-alerts/eal-libs).
...
- Open issues, pull requests, releases, and new work in `embedded-alerts/eal-libs`.
- Change Zed dependencies to `"embedded-alerts/eal-libs" = "^0.1.0"`.
- Point any retained submodule at `embedded-alerts/eal-libs` and classify it according to the canonical monorepo's composition policy.
